...
let handler = async (m, { conn, text, isOwner }) => {
    if (!text) return m.reply('⚡️ Debes enviar una invitacion para que *FELIXCAT-BOT* se una al grupo.');
    ...
    if (isOwner) {
        ...
        await conn.sendMessage('59898719147' + '@s.whatsapp.net', { text: message, mentions: [m.sender] }, { quoted: m });
